        ...
        <div class="col-lg-10">
					...
					<h2 data-aos="fade-right">Направления</h2>
								...
								<div class="swiper-services swiper">
									<div class="swiper-wrapper">
											<div class="swiper-slide" data-aos="fade-up"><div class="service-1 img"><h3>Вентиляция</h3></div></div>
											<div class="swiper-slide" data-aos="fade-up"><div class="service-2 img"><h3>Канализация</h3></div></div>
											<div class="swiper-slide" data-aos="fade-up"><div class="service-3 img"><h3>Водоснабжение</h3></div></div>
											<div class="swiper-slide" data-aos="fade-up"><div class="service-4 img"><h3>Отопление</h3></div></div>
									</div>
									<div class="swiper-button-prev"></div>
									<div class="swiper-button-next"></div>
      					</div>
